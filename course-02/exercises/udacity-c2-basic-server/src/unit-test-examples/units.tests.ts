...
describe('concat', () => {
  ...
  it('should throw an error if both empty strings', () => {
    expect(() => { concat('','') }).to.throw('empty strings')
  });

  it('should throw an error if a empty strings', () => {
    expect(() => { concat('hello','') }).to.throw('empty strings')
  });

  it('should throw an error if b empty strings', () => {
    expect(() => { concat('','world') }).to.throw('empty strings')
  });
